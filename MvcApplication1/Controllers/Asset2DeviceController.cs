...
{
    public class Asset2DeviceController : ApiController
    {
        public void Post(string appKey, string assetid, string deviceid, [FromBody]string value)
        {
            ...
            if (appKey == "ttpapikey.asxc123nju89mno0")
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        {
                            cmd = new SqlCommand("sp_AssetDeviceMap", con);
